...
class TableViewModel  : ViewModel() {
    ...
    private var questionBank = listOf(
        Question("0 x 0 = ", 0, 3,5,7,0, 0),
        Question("0 x 1 = ", 1, 0,2,5,0, 0),
        Question("0 x 2 = ", 6, 2,9,0,0, 0),
        Question("0 x 3 = ", 3, 0,5,8,0, 0),
        Question("0 x 4 = ", 1, 4,0,2,0, 0),
        Question("0 x 5 = ", 0, 8,5,4,0, 0),
        Question("0 x 6 = ", 2, 3,1,0,0, 0),
        Question("0 x 7 = ", 5, 9,0,7,0, 0),
        Question("0 x 8 = ", 8, 0,1,2,0, 0),
        Question("0 x 9 = ", 1, 3,0,2,0, 0),
        Question("0 x 10 = ", 10, 6,4,0,0, 0),
        Question("0 x 11 = ", 1, 11,0,6,0, 0),

        Question("1 x 0 = ", 0, 1,5,10,0, 1),
        ...
        Question("1 x 11 = ", 0, 13,11,17,11, 1),

        Question("2 x 0 = ", 4, 0,5,1,0, 2),
        ...
        Question("2 x 11 = ", 25, 34,35,22,22, 2),

        Question("3 x 0 = ", 10, 23,0,7,0, 3),
        ...
        Question("3 x 11 = ", 11, 33,55,57,33, 3),

        Question("4 x 0 = ", 0, 31,40,3,0, 4),
        ...
        Question("4 x 11 = ", 25, 44,22,63,44, 4),

        Question("5 x 0 = ", 5, 50,0,7,0, 5),
        ...
        Question("5 x 11 = ", 55, 33,17,22,55, 5),

        Question("6 x 0 = ", 0, 60,5,7,0, 6),
        ...
        Question("6 x 11 = ", 61, 72,81,66,66, 6),

        Question("7 x 0 = ", 70, 0,45,7,0, 7),
        ...
        Question("7 x 11 = ", 18, 38,81,77,77, 7),

        Question("8 x 0 = ", 80, 0,16,32,0, 8),
        ...
        Question("8 x 11 = ", 19, 35,88,56,88, 8),

        Question("9 x 0 = ", 12, 90,0,9,0, 9),
        ...
        Question("9 x 11 = ", 99, 63,20,109,99, 9),

        Question("10 x 0 = ", 0, 10,1,25,0, 10),
        ...
        Question("10 x 11 = ", 111, 3,110,21,110, 10),

        Question("11 x 0 = ", 11, 110,2,0,0, 11),
        Question("11 x 1 = ", 111, 12,11,21,11, 11),
        Question("11 x 2 = ", 30, 13,35,22,22, 11),
        Question("11 x 3 = ", 57, 33,45,27,33, 11),
        Question("11 x 4 = ", 44, 15,114,24,44, 11),
        Question("11 x 5 = ", 16, 61,55,73,55, 11),
        Question("11 x 6 = ", 17, 24,58,66,66, 11),
        Question("11 x 7 = ", 77, 18,9,7,77, 11),
        Question("11 x 8 = ", 90, 88,12,18,88, 11),
        Question("11 x 9 = ", 20, 29,99,27,99, 11),
        Question("11 x 10 = ", 32, 110,21,54,110, 11),
        Question("11 x 11 = ", 99, 22,105,121,121, 11)
    )
